...
<section class="jumbotron introduction">
    ...
    <p>The Music Tank is (currently) a team of 2 music enthusiasts who work together during our free time to build a place where people come hang out and discuss music.</p>
</section>
...
<div class="row team">
    <div class="col-md-2">
        <img src="https://pbs.twimg.com/profile_images/3354801626/921b36d3a93bce4904532760df133fd0.jpeg" class="img-circle" alt="Francois Faubert" />
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-2">
        <img src="https://pbs.twimg.com/profile_images/107322449/chevreuiljlucJorion.jpg" class="img-circle" alt="Julien Guay" />
    </div>
    <div class="col-md-4">
        <h4>Julien Guay</h4> 
        <ul> 
