...
<h2><?php echo __("Legalities"); ?></h2>

<p>There's no use pretending, we are not a business and we do not have any legal guidelines.</p>

<h3><?php echo __("Ok then: 'Technicalities'"); ?></h3>

<p>What is worth mentioning is that all music is not hosted directly on this server. Music is
provided by public APIs of music streaming services.</p>
...
<p>Each time you login to this website, we pull your whole collection and update our list of artists with it. 
