...
exports.default = new _vuex2.default.Store({
    ...
    getters: {
        ...
        upvotes: function upvotes(state) {
            return state.upvotes;
        },
        reviewFrames: function reviewFrames(state) {
            return state.frames;
        }
    },
    ...
    mutations: {
        ...
        updateFrames: function updateFrames(state, framesCache) {
            state.frames = framesCache;
        },
        updateVotes: function updateVotes(state, upvotesCache) {
            state.upvotes = upvotesCache;
        },
        addTrackUpvote: function addTrackUpvote(state, _ref) {
            var id = _ref.id,
                vote = _ref.vote;

            var upvotesCache = state.upvotes;
            upvotesCache.addTrackUpvote(id, vote);
            state.upvotes = upvotesCache;
        },
        removeTrackUpvote: function removeTrackUpvote(state, id) {
            var upvotesCache = state.upvotes;
            upvotesCache.removeTrackUpvote(id);
            state.upvotes = upvotesCache;
        },
        addAlbumUpvote: function addAlbumUpvote(state, _ref2) {
            var id = _ref2.id,
                vote = _ref2.vote;
        ...
        removeAlbumUpvote: function removeAlbumUpvote(state, id) {
            var upvotesCache = state.upvotes;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(47), __webpack_require__(376)(module)))
...
var _SearchForm = __webpack_require__(369);

var _SearchForm2 = _interopRequireDefault(_SearchForm);

var _Upvote = __webpack_require__(370);
...
var _reviewFrames = __webpack_require__(161);

var _reviewFrames2 = _interopRequireDefault(_reviewFrames);

var _upvotes = __webpack_require__(162);

var _upvotes2 = _interopRequireDefault(_upvotes);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

Tmt.app = new _vue2.default({
    el: 'section.app',
    store: _store2.default,
    components: {
        SearchForm: _SearchForm2.default, Upvote: _Upvote2.default
    },
    methods: {
        ...
        profile: function profile(data) {
            var profile = new _profile2.default(data);
            this.$store.commit('updateProfile', profile);
        },
        upvotes: function upvotes(data) {
            var upvote = new _upvotes2.default(data);
            this.$store.commit('updateVotes', upvote);
        },
        reviewFrames: function reviewFrames(key, data) {
            var frames = new _reviewFrames2.default(data);
            this.$store.commit('updateFrames', { key: key, frames: frames });
        },
        setWaveData: function setWaveData(data) {
            // this.$store.commit('wave', { data })
        }
    },
    computed: (0, _vuex.mapGetters)(['profile', 'reviewFrames'])
});
...
var _bloodhoundJs = __webpack_require__(93);
...
exports.default = {
    ...
    methods: {
        resultSelected: function resultSelected(event) {
            event.preventDefault();
            document.location = this.getSelectResultElement().attr('href');
        },
        getSelectResultElement: function getSelectResultElement() {
...
function getSource(key, endpoint) {
    var source = new _bloodhoundJs2.default({
        name: key,
        datumTokenizer: _bloodhoundJs2.default.tokenizers.obj.whitespace(key),
    ...
    return [{
        ...
        templates: {
            ...
            suggestion: function suggestion(data) {
                return ['<p><a href="/artists/' + data.slug + '/">' + data.name + '</a></p>'].join("");
            }
        }
    }, {
        name: 'albums',
        ...
        templates: {
            ...
            suggestion: function suggestion(data) {
                return ['<p><a href="/albums/' + data.slug + '/">' + data.name + '</a> by <a href="/artists/' + data.artist.slug + '/">' + data.artist.name + '</a></p>'].join("");
            }
        }
    }, {
        name: 'tracks',
        ...
        templates: {
            ...
            suggestion: function suggestion(data) {
                return ['<p><a href="/tracks/' + data.slug + '/">' + data.name + '</a> by <a href="/artists/' + data.artist.slug + '/">' + data.artist.name + '</a></p>'].join("");
            }
        }
    }];
};
...
exports.default = {
    ...
    computed: _extends({}, (0, _vuex.mapGetters)(['upvotes']), {
    ...
    methods: {
        ...
        save: function save(value) {
            ...
            var action = this.type == "track" ? "addTrackUpvote" : "addAlbumUpvote";
            var payload = { id: this.objectId, vote: value };

            this.lock();
            this.ajax().post('/ajax/' + action, payload).then(function (response) {
                _this.$store.commit(action, payload);
                _this.unlock();
        ...
        remove: function remove(value) {
            ...
            var action = this.type == "track" ? "removeTrackUpvote" : "removeAlbumUpvote";
            var payload = { id: this.objectId };

            this.lock();
            this.ajax().post('/ajax/' + action, payload).then(function (response) {
                _this2.$store.commit(action, _this2.objectId);
                _this2.unlock();
            }).catch(function (error) {
                Tmt.app.error(error);
                _this2.unlock();
...
// Configure jQuery across the website
...
var ReviewFrames = function ReviewFrames(frameData) {
    _classCallCheck(this, ReviewFrames);
...
var Profile = function () {
    function Profile(userData, upvoteCache) {
    ...
    _createClass(Profile, [{
        ...
        key: 'getVoteByObjectId',
        value: function getVoteByObjectId(type, objectId) {
            var data = type == "track" ? this.trackUpvotes : this.albumUpvotes,
                match = _lodash2.default.filter(data, { id: objectId });
...
var _frame = __webpack_require__(159);
...
var ReviewFrames = function ReviewFrames(frameData) {
    ...
    frameData.forEach(function (frameData) {
        _this.cache.push = new _frame2.default(frameData);
    });
};
...
var UpvoteCache = function () {
    function UpvoteCache(userData) {
        _classCallCheck(this, UpvoteCache);
    ...
    _createClass(UpvoteCache, [{
        key: 'addAlbumUpvote',
        value: function addAlbumUpvote(key, value) {
        ...
        key: 'addTrackUpvote',
        value: function addTrackUpvote(key, value) {
        ...
        key: 'removeAlbumUpvote',
        value: function removeAlbumUpvote(id) {
            var index = this.albumUpvotes.map(function (vote) {
                return vote.id;
        ...
        key: 'removeTrackUpvote',
        value: function removeTrackUpvote(id) {
            var index = this.trackUpvotes.map(function (vote) {
                return vote.id;
            }).indexOf(parseInt(id, 10));
            if (index > -1) {
        ...
        key: 'findByTrackId',
        value: function findByTrackId(id) {
            var vote = this.trackUpvotes.find(function (vote) {
                return parseInt(vote.id, 10) == parseInt(id, 10);
            });
            if (vote) {
                return vote.vote;
            }
        ...
        key: 'findByAblumId',
        value: function findByAblumId(id) {
            var vote = this.albumUpvotes.find(function (vote) {
                return parseInt(vote.id, 10) == parseInt(id, 10);
            });
            if (vote) {
                return vote.vote;
        ...
        key: 'getVote',
        value: function getVote(type, id) {
            return type == "track" ? this.findByTrackId(id) : this.findByAblumId(id);
        }
    }]);
...
if(!(TO_PRIMITIVE in proto))__webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(178));
...
exports.push([module.i, "\n.ctrl-upvote {\n  background: #efefef;\n  border: 1px solid #dedede;\n  border-radius: 3px;\n  display: inline-block;\n  text-align: center;\n  margin: 1px 0;\n  width: 66px;\n  vertical-align: middle;\n}\n.ctrl-upvote.liked li:nth-child(2) {\n    display: none;\n}\n.ctrl-upvote.disliked li:nth-child(1) {\n    display: none;\n}\n.ctrl-upvote ul {\n    display: block;\n    list-style-type: none;\n    padding: 0;\n    margin: auto;\n}\n.ctrl-upvote ul li {\n      display: inline-block;\n      padding: 0;\n      margin: 0;\n}\n.ctrl-upvote button {\n    border: none;\n    background: #efefef;\n    cursor: pointer;\n    color: #333;\n    font-size: 14px;\n    text-shadow: 0 1px #fff;\n    height: 30px;\n    width: 30px;\n}\n.ctrl-upvote button:hover {\n      color: blue;\n}\n.ctrl-upvote button:disabled, .ctrl-upvote button:disabled:hover {\n      color: #ccc;\n}\n", ""]);
...
Component.options.__file = "E:\\dev\\themusictank.com\\resources\\assets\\js\\components\\SearchForm.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6418fcf1", Component.options)
  } else {
    hotAPI.reload("data-v-6418fcf1", Component.options)
  }
})()}
...
Component.options.__file = "E:\\dev\\themusictank.com\\resources\\assets\\js\\components\\Upvote.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] Upvote.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f3f35f2c", Component.options)
  } else {
    hotAPI.reload("data-v-f3f35f2c", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6418fcf1", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "ctrl ctrl-upvote",
    class: {
      'liked': _vm.value == 1, 'disliked': _vm.value == 2
    }
    ...
    staticClass: "fa",
    class: {
      'fa-thumbs-o-up': _vm.value != 1, 'fa-thumbs-up': _vm.value == 1
    },
    attrs: {
      "aria-hidden": "true"
    }
    ...
    staticClass: "fa",
    class: {
      'fa-thumbs-o-down': _vm.value != 2, 'fa-thumbs-down': _vm.value == 2
    },
    attrs: {
      "aria-hidden": "true"
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-f3f35f2c", module.exports)
  }
}
...
var update = __webpack_require__(374)("b730afac", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-f3f35f2c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Upvote.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-f3f35f2c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Upvote.vue");
...
var listToStyles = __webpack_require__(375)
