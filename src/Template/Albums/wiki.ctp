...
<article class="container container-fluid">
    ...
    <div class="row content headerless">
        <div class="col-md-12">
            ...
            <span class="report-bug" data-bug-type="album wiki" data-location="album/<?= $album->slug; ?>" data-user="<?= $this->request->session()->read('Auth.User.User.id'); ?>"><i class="fa fa-bug"></i> <?= __("Wrong/weird bio?"); ?></span>
